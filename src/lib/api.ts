...
export const createBot = (data: Record<string, unknown>): Promise<AxiosResponse> =>
  apiClient.post("/bots/create", data);
...
export const sendMessage = (data: Record<string, unknown>): Promise<AxiosResponse> =>
